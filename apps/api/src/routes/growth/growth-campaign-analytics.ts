// Split from growth-campaigns.ts (scripts/check-route-size.sh) — read-only
// campaign/commerce analytics (roadmap R) + reactivation audience suggestions
// (roadmap G). Route bodies verbatim.
import { prisma } from '@kanchuki/db';
import type { FastifyPluginAsync } from 'fastify';
import { z } from 'zod';
import { hasFeature } from '../../lib/features.js';
import { featureUnavailable } from '../../plugins/error-handler.js';
import { abTestSignificance, type AbVariantResult } from './growth-helpers.js';
