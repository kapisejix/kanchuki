...
// The sitemap (app/sitemap.xml + app/sitemap/[id] route handlers) enumerates
// every live store's storefront URLs and product images — Google's indexer
// is pointed there so new stores/categories get crawled without relying on
// link discovery.
