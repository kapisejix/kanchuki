  ...
  return (
    <div className="min-h-screen bg-cotton text-ink-900">
      <div className="mx-auto max-w-2xl px-6 py-16">
        ...
        <p className="mt-2 text-sm text-ink-500">Last updated: August 8, 2026</p>
        ...
        <div className="mt-8 space-y-6 text-ink-700">
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-ink-900">1. Eligibility &amp; accounts</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-ink-900">2. The service</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-ink-900">3. Your content</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-ink-900">4. Payments &amp; billing</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-ink-900">5. GST invoicing</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-ink-900">6. Acceptable use</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-ink-900">7. Availability &amp; liability</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-xl font-semibold text-ink-900">8. Changes to these terms</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:support@kanchuki.app" className="text-rust-600 hover:underline">
