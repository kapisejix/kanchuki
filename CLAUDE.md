...
| 46 | Marketing & Sales Enablement Phase 1 (Smart Incentive Engine, Local Discovery Engine, GMB Integration, AI-Driven Social Media Templates) | In Progress | 2026-08-19 | See `docs/INDIA-RETAILER-GROWTH.md` section 8 |
| 47 | Partner Network Manager (Marketing & Sales Enablement) — API route exists, `schema.prisma` currently fails `prisma validate` (invalid inline enum syntax), no migration applied, no admin/mobile UI | 🔴 Planned | 2026-08-20 | PRO-REQUIREMENTS §29 |
