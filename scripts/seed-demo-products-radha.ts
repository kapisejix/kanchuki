...
const LADIES_SUITS: DummyItem[] = [
  ...
  {
    name: 'Straight-Cut Salwar Suit - Dusty Pink',
    subtype: 'Salwar Suit',
    color: 'Dusty Pink',
    fabric: 'Cotton',
    pattern: 'Printed',
  ...
  {
    name: 'Palazzo Suit Set - Mustard Yellow',
    subtype: 'Palazzo Suit',
  ...
  {
    name: 'Sharara Suit - Royal Blue',
    subtype: 'Sharara Suit',
    color: 'Royal Blue',
    fabric: 'Silk Blend',
    pattern: 'Embellished',
    priceMin: 3200,
  ...
  {
    name: 'Cotton Printed Suit - Sea Green',
    subtype: 'Kurta Set',
    color: 'Sea Green',
    fabric: 'Cotton',
  ...
  {
    name: 'Georgette Party Suit - Wine Red',
    subtype: 'Suit with Dupatta',
    color: 'Wine Red',
    fabric: 'Georgette',
    pattern: 'Sequinned',
    priceMin: 2800,
  ...
  {
    name: 'Patiala Suit - Turquoise',
    subtype: 'Patiala Suit',
    color: 'Turquoise',
    fabric: 'Cotton',
    pattern: 'Solid',
    priceMin: 1600,
  ...
  {
    name: 'Chikankari Suit - Ivory White',
    subtype: 'Kurta Set',
    color: 'Ivory White',
    fabric: 'Cotton',
    pattern: 'Chikankari',
  ...
  {
    name: 'Banarasi Silk Suit - Maroon',
    subtype: 'Suit with Dupatta',
    color: 'Maroon',
  ...
  {
    name: 'Angrakha Style Suit - Coral',
    subtype: 'Angrakha Suit',
    color: 'Coral',
    fabric: 'Muslin',
    pattern: 'Solid',
    priceMin: 2100,
  ...
  {
    name: 'Punjabi Suit - Bottle Green',
    subtype: 'Punjabi Suit',
    color: 'Bottle Green',
    fabric: 'Cotton Silk',
    pattern: 'Phulkari',
    priceMin: 1900,
  ...
  {
    name: 'Designer Suit with Dupatta - Peach',
    subtype: 'Suit with Dupatta',
    color: 'Peach',
    fabric: 'Net',
    pattern: 'Embroidered',
...
const MEN: DummyItem[] = [
  {
    name: 'Formal Cotton Shirt - White',
  ...
  {
    name: 'Kurta Pajama Set - Cream',
    subtype: 'Kurta Pajama',
    color: 'Cream',
    fabric: 'Cotton Silk',
    pattern: 'Solid',
    priceMin: 1600,
  ...
  {
    name: 'Casual Denim Shirt - Light Blue',
  ...
  {
    name: 'Bandhgala Suit - Charcoal',
    subtype: 'Bandhgala Suit',
    color: 'Charcoal Grey',
    fabric: 'Wool Blend',
    pattern: 'Solid',
    priceMin: 5500,
...
const KIDS: DummyItem[] = [
  ...
  {
    name: 'Girls Lehenga Choli - Mini',
    subtype: 'Lehenga Choli',
    color: 'Red',
    fabric: 'Silk Blend',
    pattern: 'Embroidered',
    priceMin: 1500,
...
async function main() {
  ...
  console.log(
    `Created ${created} demo products (12 per category x 4 categories) with placeholder photos.`,
  );
}
