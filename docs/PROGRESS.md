...
8. Not started at all: `apps/mobile/app/product/catalog-import.tsx` (bulk review screen) doesn't show Style/Fabric per-item — out of scope for this pass, flagged not forgotten.
