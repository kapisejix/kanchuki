...
- `skill://performance-optimization` — VTO input-quality pipeline (maskless Fashion V-Tone, per `docs/PRO-REQUIREMENTS.md` F-102 / ADR-006)
...
- `ADR-006-defer-3d-parametric-vto.md` — Why 3D parametric VTO is deferred; engine swap to Fashion V-Tone v1.5 (2026-07-16)
