...
| CatVTON-on-RunPod try-on, admin-gated launch + dual quota (F-039 Phase 2) | `pending/catvton-runpod-tryon-launch.md` | 🔴 Planned — build now, launch later (owner go-ahead 2026-09-26) | T0 ✅ 2026-09-26 — RunPod endpoint exists + GHCR image pullable; `workersMax` still needs owner's API key; T6 consent/notice text before flag flips on |
