# Root Cause — Issue Tracker (part 2: RC-030 and older)

> Continuation of [`root-cause issues.md`](./root-cause%20issues.md) (RC-031 and newer) — split 2026-09-26 to stay under the 150k-char doc limit. Same format, same rules, one tracker across both files.
