...
- **Commit:** introduced by migration `102` in `419180e3` (2026-09-18), which pointed the 8 MODEL rows at `engine = 'imagen_3'`; found and fixed 2026-09-18 — **uncommitted at the time of writing** (see `docs/BUILD-LOG.md` §2026-09-18 "later still" and §2026-09-18 stage 3, and migrations `104` / `105`)
