...
**Commit:** *(this task)* · docs only. New `docs/references/guides/disaster-recovery.md`.
...
**Commit:** *(this task)* · `scripts/load/k6/{mix,storefront,retailer}.js` + `apps/api/src/routes/load-test.test.ts` + `docs/references/guides/load-testing.md`. No migration, no `apps/mobile` file, no `apps/web` file.
