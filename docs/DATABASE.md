...
Retailer → retailer: an existing paying retailer earns a recurring commission for bringing another retailer onto Kanchuki. Spec + task breakdown: `docs/tasks/referral-program-retailer-affiliate.md`. **T1–T6 are built; T7–T10 are not started.** Migrations 109–112 are **not applied**.
